 ...
 * @linkDeArchivo http://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&category=29&problem=647&mosmsg=Submission+received+with+ID+9489154
 * @veredict Accepted 
 * @problemId 706
 * @problemName  LC Display
